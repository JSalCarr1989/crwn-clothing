...
export function* fetchCollectionsAsync() {
   ...
   const collectionsMap = yield call(convertCollectionsSnapshotToMap,snapshot) //<--- el primer valor sera la funcion que queremos llamar, los subsecuentes los parametros que reciba.
